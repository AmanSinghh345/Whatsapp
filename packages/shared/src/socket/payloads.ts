...
import type { MessageDeletedDto, MessageDto, MessageEditedDto, MessageReactionUpdatedDto, MessageReceiptUpdatedDto, SendMessageRequestDto, UpsertReceiptDto } from "../dto/messages.dto.js";
...
export type ServerToClientEvents = {
  ...
  "message:edited": (payload: MessageEditedDto) => void;
  "message:deleted": (payload: MessageDeletedDto) => void;
  "message:receipt:updated": (payload: MessageReceiptUpdatedDto) => void;
